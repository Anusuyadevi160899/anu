...
Original file is located at
    https://colab.research.google.com/drive/1TBFUYFChvm0N16uZrwdWHocyvT48bDXM
"""
...
def format_data(account):
    ...
    return (f" name is :{account_name} and description is {account_desc} and country is {account_country}")
...
while end_of_game:
  ...
  print(vs)
  print(f" compare against B: {format_data(account_b)}")
